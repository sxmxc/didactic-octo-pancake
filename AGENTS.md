...
1. **Document-first mindset.** When you add, remove, or significantly change a system, update `README.md` and/or `TODO.md` in the same change so newcomers understand how to interact with it.
2. **Task tracking.** Keep `TODO.md` curated—if you finish a task, remove it; if you discover new work, describe it with clear entrypoints and definitions of done.
